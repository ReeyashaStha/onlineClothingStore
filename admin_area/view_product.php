                  ...
                  if(mysqli_num_rows($query_run)>0)//record is present or not
                  {
                    foreach($query_run as $row){
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="edit.php?editid=<?php echo $row['product_id']; ?>" class="btn btn-light bg-info text-light my-1">Edit</a>
                        </td>
                        <td>
                          <a href="delete.php?deleteid=<?php echo $row['product_id']; ?>" class="btn btn-danger text-light my-1">Delete</a>
                        </td>
