...
if(isset($_POST['insert_product'])){
   ...
   $temp_image=$_FILES['product_image']['tmp_name'];
    ...
    if($product_title==NULL|| $description==NULL || $product_categories==NULL || 
    $product_price==NULL || $product_image==NULL ){
     ...
     exit();
        ...
        //insert query
        $insert_products="insert into `producttable` (product_title,product_description,
        ...
        if($result_query){
            ...
            echo "data not inserted".mysqli_error($result_query);
        }
     }
    ...
    <div class="container mt-3">
        ...
        <?php
            ...
            <div class="from-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_title" id="product_title" value="<?php echo $row['product_title']; ?>" 
            ...
            <div class="from-outline mb-4 w-50 m-auto">
                ...
                echo $row['product_description']; ?>" class="form-control"  autocomplete="off" >

            </div>
            <!--categories-->
            <div class="from-outline mb-4 w-50 m-auto">
                <select name="product_categories" class="form-select" id="">
                    <option value="<?php echo $row['product_categories']; ?>">Select Category</option>
            ...
            <div class="from-outline mb-4 w-50 m-auto">
                ...
                class="form-control" autocomplete="off" >
                <input type="hidden" name="img_old" value="<?php echo $row['product_image']; ?>"/>
            </div>
