...
<div class="class">
  <h2 class="class text-center">Formal Wears</h2>
</div>
...
?>
   ...
   //  if(isset($_GET['producttable'])){
    ...
    $select_query="Select * from `producttable` where product_categories='Formal'";
    ...
    while($row=mysqli_fetch_assoc($result_query)){
      ...
      $select_query="Select * from `producttable`";
      $result_query=mysqli_query($conn,$select_query);
      //$row=mysqli_fetch_assoc($result_query);
      //echo $row['product_title'];
      while($row=mysqli_fetch_assoc($result_query)){
        ...
        <div class='card'>
          ...
          <div class='card-body'>
            <h3 class='text-center'> $product_title</h3>
            <p class='text-center'>$product_description</p>
            <h2>$product_price<a href='#' class='btn btn-primary'>Add to cart</a></h2>
          </div>
        </div>
      </div>";
